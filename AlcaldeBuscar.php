...
$sql ="SELECT * FROM alcalde WHERE id_alcalde ='".$_REQUEST['id_alcalde']."';";
...
<table border="0x">
		<form method="post" action="ManejadorAlcalde.php?accion=save" method="post" id="alcalde" value="<?php print $datos[0][0]; ?>">
           <tr>
                <td>
                    Dui:
                </td>
		  ...
		  <tr>
				...
				<td>
					<input name="Nombre" value="<?php print $datos[0][2]; ?>" type="text" placeholder="Nombre Alcalde" required="required" maxlength="35">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input name="Apellidos" value="<?php print $datos[0][3]; ?>" type="text" placeholder="Apellido Alcalde" required="required" maxlength="35">
				</td>
			</tr>
            <tr>
                <td>
