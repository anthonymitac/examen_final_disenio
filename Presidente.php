...
<table border="0x">
		<form method="post" action="ManejadorPresidente.php?accion=save" method="post" id="presidente">
              <tr>
                <td>
                    Dui:
                </td>
			...
			<tr>
				...
				<td>
					<input name="Nombres" type="text" placeholder="Nombre Presidente" required="required" maxlength="35">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input name="ApellidosCandidato" type="text" placeholder="Apellido Presidente" required="required" maxlength="35">
				</td>
			</tr>
            <tr>
                <td>
