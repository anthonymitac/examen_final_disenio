...
<table border="0x">
		<form method="post" action="ManejadorDiputado.php?accion=save" method="post" id="diputado">
           <tr>
                <td>
                    Dui:
                </td>
		  ...
		  <tr>
				...
				<td>
					<input name="nombre" type="text" placeholder="Nombre Diputado" required="required" maxlength="35">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input name="Apellidos" type="text" placeholder="Apellido Diputado" required="required" maxlength="35">
				</td>
			</tr>
            <tr>
                <td>
